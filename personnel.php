            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">จัดการข้อมูลบุคลากร</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ข้อมูลสมาชิก </span></h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">แก้ไขมูลสมาชิก</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" id="type_id" required>
                            ...
                            <option value="3">หัวหน้าแผนก</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="save_personnel">บันทึก</button>
                </div>
            </div>
        </div>
    </div>
