            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">จัดภาคเรียน</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ข้อมูลภาคเรียน <button type="button"
                                        class="btn btn-primary  btn-sm " data-toggle='modal' data-target='#add_semester'><span
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มเทอมกการศึกษา</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">ภาคเรียนที่:</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="year_tern">บันทึก</button>
                </div>
            </div>
        </div>
    </div>
