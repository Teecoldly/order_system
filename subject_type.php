...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ข้อมูลรายวิชา</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">เพิ่มข้อมูลรายวิชา <button type="button"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">แก้ไขชื่อวิชา</h5>
                ...
                <div class="modal-body">
                    <div class="form-group" hidden>
                        ...
                        <input type="text" class="form-control" id="id" hidden disabled>
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">ชื่อวิชา:</label>
                        <input type="text" class="form-control" id="subject_edit_name">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="subject_type_edit">บันทึก</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                    <button type="button" class="btn btn-primary" id="subject_save">บันทึก</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="js/subject_type.js"></script>
