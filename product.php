            ...
            <div class="modal-content">
                ...
                <div class="form-group" hidden>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="product_price_edit">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">หน่วยเรียก</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="product_type_edit">บันทึก</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                    <button type="button" class="btn btn-primary" id="product_add">บันทึก</button>
                </div>
            </div>
        </div>
    </div>
